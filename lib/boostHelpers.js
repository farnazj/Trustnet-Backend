...
async function getBoostersandCredSources(req) {
  ...
  unmuted_followeds_ids = unmuted_followeds_ids.concat(auth_user_.id);
...
async function buildActivityQuery(req, activity_user) {
...
async function getPostBoosts(post_ids, req, boosters_ids, assessor_ids) {
