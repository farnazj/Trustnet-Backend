...
async function notifyInquirers(assessment, questionAskers, assessor, post) {
  ...
  let postCredibility = assessment.postCredibility != constants.VALIDITY_CODES.QUESTIONED ?
    (assessment.postCredibility == constants.VALIDITY_CODES.CONFIRMED ? 'accurate' : 'innacurate') : '';
